...
// overload the stream extraction operator to 
// work with Rational objects
...
{
	Rational result;
	// we will not complete this operator, but please
	// note that it's a friend of the Rational class. Thus,
	// although it's a nonmember function, it can access the
	// private data members of Rational directly.
	lhs.mpDenominator; // mpDenominator is a private data member of Rational
