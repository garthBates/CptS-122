...
// History: 10/5 - Implemented overloaded stream extraction operator
//                 to work with files and Rational objects.
//          10/3 - Changed the private data members of 
...
int main(void)
{
	...
	input >> r1; // The stream extraction operator has been overloaded!!!
